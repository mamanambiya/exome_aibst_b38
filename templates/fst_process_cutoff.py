...
parser.add_argument("--fst_cutoff", help="", default="${fst_cutoff}")
parser.add_argument("--pops", help="", default="${pops}")
args = parser.parse_args()


def process_fst(fst_weir, fst_weir_out, mean_fst_out, fst_cutoff='', pops=''):
    """_summary_
    """
...
if __name__ == '__main__':
    process_fst(args.fst_weir, args.fst_weir_out,
                args.mean_fst_out, args.fst_cutoff, args.pops)
