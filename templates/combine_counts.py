...
parser.add_argument("--csv_labels", default="${csv_labels}", help="")
parser.add_argument("--csv_chrms", default="${csv_chrms}", help="")
parser.add_argument("--csv_out", default="${csv_out}", help="")

args = parser.parse_args()

def combine_csv_counts(csv_counts, csv_labels, csv_chrms, csv_out):
    """
    :param pop_freqs:
    :return:
    """
...
if __name__ == '__main__':
    combine_csv_counts(args.csv_counts, args.csv_labels, args.csv_chrms, args.csv_out)
